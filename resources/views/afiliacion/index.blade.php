  				...
  				<div class="well well-sm ">
						...
						{!! Form::open(array('method' => 'POST','role' => 'form','class' => "form-inline", "autocomplete" => "off")) !!}
							...
							<div class="form-group">
								...
								<a href="{{url('prueba')}}" class="btn btn-success con-tooltip" title="Crear Afiliado"><i class="fa fa-upload"></i> Importar</a>
							</div>

							<div class="form-group">

								<a href="{{url('exportar_afiliacion')}}" class="btn btn-success con-tooltip" title="Exportar Afiliados"><i class="fa fa-download"></i> Exportar</a>
							</div>
									...
									<tr>
										...
										<td>
											...
											<div class="hidden-xs">
												...
												<a href="{{ url('editar', ['id' => $afiliado->id])}}" class="btn btn-xs btn-success con-tooltip" title="Editar"><i class="fa fa-gear"></i></a>
