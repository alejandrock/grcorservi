			...
			<div class="offset-sm-2 col-sm-10" >
				...
				<div class="well well-sm ">
					...
					<div class="form-group">
						...
						{!! Form::text('nombre', NULL, array('class' => 'form-control', 'placeholder' => "Nombre Del empleado")); !!}
					</div>
					...
					<div class="form-group">
						...
						<a href="{{url('crear_afiliacion')}}" class="btn btn-success con-tooltip" title="Crear empleado"><i class="fa fa-plus"></i> Nuevo</a>
					</div>

					<div class="form-group">

						<a href="{{url('prueba')}}" class="btn btn-success con-tooltip" title="Crear empleado"><i class="fa fa-upload"></i> Importar</a>
					</div>

					<div class="form-group">

						<a href="{{url('exportar_afiliacion')}}" class="btn btn-success con-tooltip" title="Exportar empleados"><i class="fa fa-download"></i> Exportar</a>
					</div>
									...
									<tr>
										...
										<td>
											...
											<div class="hidden-xs">
												...
												<a href="{{ url('empleado', ['id' => $empleado->id])}}" class="btn btn-xs btn-primary con-tooltip" title="Ver detallado"><i class="fa fa-list"></i></a>
													
												<a href="{{ url('editar', ['id' => $empleado->id])}}" class="btn btn-xs btn-success con-tooltip" title="Editar"><i class="fa fa-gear"></i></a>
